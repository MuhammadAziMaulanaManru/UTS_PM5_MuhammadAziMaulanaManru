...
class QuizPageTwo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnOpsiKedua.setOnClickListener { sendAnswer("Correct Answer!") }
    ...
    private fun sendAnswer(answer: String) {
        ...
        val intent = Intent(this, QuizPageThree::class.java)
        intent.putExtra("ANSWER_RESULT_1", answerResult1)
        intent.putExtra("ANSWER_RESULT_2", answer)
